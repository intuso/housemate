...
public class PluginResourceBridgeReverse<FROM, TO> implements PluginResource<TO> {
    ...
    private final com.intuso.housemate.client.real.api.internal.driver.PluginResource<FROM> pluginResource;
    private final Function<? super FROM, ? extends TO> convertFrom;

    public PluginResourceBridgeReverse(com.intuso.housemate.client.real.api.internal.driver.PluginResource<FROM> pluginResource, Function<? super FROM, ? extends TO> convertFrom) {
        this.pluginResource = pluginResource;
        this.convertFrom = convertFrom;
    }

    public com.intuso.housemate.client.real.api.internal.driver.PluginResource<FROM> getPluginResource() {
    ...
    private class ListenerBridge implements com.intuso.housemate.client.real.api.internal.driver.PluginResource.Listener<FROM> {
