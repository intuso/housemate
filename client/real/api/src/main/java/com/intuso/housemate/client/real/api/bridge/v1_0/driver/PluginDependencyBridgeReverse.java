...
public class PluginDependencyBridgeReverse<FROM, TO> implements PluginDependency<TO> {
    ...
    private final com.intuso.housemate.client.real.api.internal.driver.PluginDependency<FROM> pluginDependency;
    private final Function<? super FROM, ? extends TO> convertFrom;

    public PluginDependencyBridgeReverse(com.intuso.housemate.client.real.api.internal.driver.PluginDependency pluginDependency, Function<? super FROM, ? extends TO> convertFrom) {
        this.pluginDependency = pluginDependency;
        this.convertFrom = convertFrom;
    }

    public com.intuso.housemate.client.real.api.internal.driver.PluginDependency getPluginDependency() {
    ...
    private class ListenerBridge implements com.intuso.housemate.client.real.api.internal.driver.PluginDependency.Listener<FROM> {
