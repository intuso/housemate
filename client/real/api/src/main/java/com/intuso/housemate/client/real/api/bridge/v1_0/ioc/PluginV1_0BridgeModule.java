...
public class PluginV1_0BridgeModule extends AbstractModule {
    ...
    @Provides
    @Singleton
    public Iterable<com.intuso.housemate.client.real.api.internal.module.PluginResource<Class<?>>> getTypes(PluginResourceMapper pluginResourceMapper, Iterable<PluginResource<Class<?>>> types) {
    ...
    @Provides
    @Singleton
    public Iterable<com.intuso.housemate.client.real.api.internal.module.PluginResource<? extends com.intuso.housemate.client.real.api.internal.driver.FeatureDriver.Factory<?>>> getDeviceDrivers(PluginResourceMapper pluginResourceMapper, FeatureDriverFactoryMapper featureDriverFactoryMapper, Iterable<PluginResource<? extends FeatureDriver.Factory<?>>> deviceDriverFactories) {
