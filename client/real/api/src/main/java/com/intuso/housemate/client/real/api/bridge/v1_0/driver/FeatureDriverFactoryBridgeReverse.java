...
public class FeatureDriverFactoryBridgeReverse implements FeatureDriver.Factory<FeatureDriver> {
    ...
    private final com.intuso.housemate.client.real.api.internal.driver.FeatureDriver.Factory<?> factory;
    private final FeatureDriverMapper featureDriverMapper;

    @Inject
    public FeatureDriverFactoryBridgeReverse(@Assisted com.intuso.housemate.client.real.api.internal.driver.FeatureDriver.Factory<?> factory,
                                             FeatureDriverMapper featureDriverMapper) {
        this.factory = factory;
        this.featureDriverMapper = featureDriverMapper;
    }

    public com.intuso.housemate.client.real.api.internal.driver.FeatureDriver.Factory<?> getFactory() {
        return factory;
    }
    ...
    private class CallbackBridge implements com.intuso.housemate.client.real.api.internal.driver.FeatureDriver.Callback {
    ...
    public interface Factory {
        FeatureDriverFactoryBridgeReverse create(com.intuso.housemate.client.real.api.internal.driver.FeatureDriver.Factory<?> featureDriverFactory);
    }
}
