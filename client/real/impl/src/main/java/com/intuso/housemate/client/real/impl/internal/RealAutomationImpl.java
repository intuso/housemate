...
public final class RealAutomationImpl
    ...
    private void rename(String newName, String newDescription) {
        ...
        for(Automation.Listener<? super RealAutomationImpl> listener : listeners)
            listener.renamed(RealAutomationImpl.this, data.getName(), data.getDescription(), newName, newDescription);
    ...
    @Override
    public void renamed(RealConditionImpl condition, String oldName, String oldDescription, String newName, String newDescription) {
        // do nothing for now
    }
