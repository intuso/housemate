...
public class TaskDriverType extends FactoryType<TaskDriver.Factory<?>> {
    ...
    @Inject
    protected TaskDriverType(@Type Logger logger, ManagedCollectionFactory managedCollectionFactory, RealOptionImpl.Factory optionFactory, RealListGeneratedImpl.Factory<RealOptionImpl> optionsFactory) {
