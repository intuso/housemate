...
public abstract class ProxyValueBaseBridge<
    ...
    protected void initChildren(String versionName, String internalName, Connection connection) throws JMSException {
        ...
        valueReceiver = new com.intuso.housemate.client.proxy.api.internal.object.JMSUtil.Receiver<>(logger,
                session.createConsumer(session.createTopic(com.intuso.housemate.client.proxy.api.internal.ChildUtil.name(versionName, Value.VALUE_ID) + "?consumer.retroactive=true")),
