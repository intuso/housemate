...
import com.intuso.housemate.client.api.bridge.v1_0.UserMapper;
...
public class ProxyUserBridge
    ...
    protected ProxyUserBridge(@Assisted Logger logger,
        ...
        super(logger, com.intuso.housemate.client.v1_0.api.object.User.Data.class, userMapper, listenersFactory);
