...
public class ProxyBridgeV1_0Module extends AbstractModule {
    ...
    protected void configure() {
        ...
        install(new FactoryModuleBuilder().build(new TypeLiteral<ProxyObjectBridge.Factory<ProxyConnectedDeviceBridge>>() {}));
        install(new FactoryModuleBuilder().build(new TypeLiteral<ProxyObjectBridge.Factory<ProxySystemBridge>>() {}));
        ...
        install(new FactoryModuleBuilder().build(new TypeLiteral<ProxyObjectBridge.Factory<ProxyListBridge<ProxyConnectedDeviceBridge>>>() {}));
        install(new FactoryModuleBuilder().build(new TypeLiteral<ProxyObjectBridge.Factory<ProxyListBridge<ProxySystemBridge>>>() {}));
