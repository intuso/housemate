...
public class RunProgramDevice extends RealDevice {
	 ...
	 */
    private final RealProperty<String> command = StringType.createProperty(getLog(), getListenersFactory(), "command", "Command", "The command for the program", Arrays.asList(""));
	 ...
	 */
    private final RealValue<Boolean> runningValue = BooleanType.createValue(getLog(), getListenersFactory(), "running", "Running", "True if the program is currently running", false);
