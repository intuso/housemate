package com.intuso.housemate.broker.dependencygraph;
...
import com.intuso.housemate.broker.BrokerModule;
import com.intuso.housemate.broker.PCModule;
...
public class DependencyGraph {
    ...
    public void graph() throws IOException {
        File outputFile = File.createTempFile("broker-graph", ".dot");
