 ...
 *
 */
public class TimeOfTheDay extends BrokerRealCondition {
	 ...
	 */
    @Inject
	public TimeOfTheDay(BrokerRealResources brokerRealResources, String id, String name, String description,
                        BrokerRealConditionOwner owner, TimeType timeType) throws HousemateException {
		super(brokerRealResources, id, name, description, owner);
        before = new BrokerRealProperty<Time>(brokerRealResources, BEFORE_FIELD, BEFORE_FIELD, "The condition is satisfied when the current time is before this time",
                timeType, DAY_END);
        after = new BrokerRealProperty<Time>(brokerRealResources, AFTER_FIELD, AFTER_FIELD, "The condition is satisfied when the current time is after this time",
                timeType, DAY_END);
