...
import com.intuso.housemate.real.impl.type.Time;
...
public class TimeOfTheDay extends BrokerRealCondition {
	...
	public TimeOfTheDay(BrokerRealResources resources, String id, String name, String description) throws HousemateException {
        ...
        before = new BrokerRealProperty<Time>(resources, BEFORE_FIELD, BEFORE_FIELD, "The condition is satisfied when the current time is before this time", new TimeType(resources.getGeneralResources().getClientResources()), DAY_END);
        after = new BrokerRealProperty<Time>(resources, AFTER_FIELD, AFTER_FIELD, "The condition is satisfied when the current time is after this time", new TimeType(resources.getGeneralResources().getClientResources()), DAY_END);
