...
public abstract class BrokerRealPrimaryObject<WBL extends HousemateObjectWrappable<HousemateObjectWrappable<?>>,
    ...
    public BrokerRealPrimaryObject(BrokerRealResources resources, WBL wrappable, final String objectType) {
        ...
        this.running = new BrokerRealValue<Boolean>(resources, RUNNING_VALUE, RUNNING_VALUE, "Whether the " + objectType + " is running or not", new BooleanType(resources.getGeneralResources().getClientResources()), false);
        ...
        this.error = new BrokerRealValue<String>(resources, ERROR_VALUE, ERROR_VALUE, "Current error for the " + objectType, new StringType(resources.getGeneralResources().getClientResources()), null);
