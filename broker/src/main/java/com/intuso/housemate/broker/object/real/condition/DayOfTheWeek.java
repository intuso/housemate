...
import com.intuso.housemate.real.impl.type.Day;
...
public class DayOfTheWeek extends BrokerRealCondition {
	...
	public DayOfTheWeek(BrokerRealResources resources, String id, String name, String description) throws HousemateException {
        ...
        days = new BrokerRealProperty<Set<Day>>(resources, DAYS_FIELD, DAYS_FIELD, "The days that satisfy the condition", new DaysType(resources.getGeneralResources().getClientResources()), EnumSet.noneOf(Day.class));
