...
public class Delay extends BrokerRealConsequence {
	...
	public Delay(BrokerRealResources resources, String id, String name, String description) {
        ...
        amount = new BrokerRealProperty<Integer>(resources, "amount", "Amount", "the amount of time to wait", new IntegerType(resources.getGeneralResources().getClientResources()), 1);
