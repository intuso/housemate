...
public class RealValue<O> extends RealValueBase<ValueData, NoChildrenData, RealObject<NoChildrenData, ?, ?, ?>, O,
     ...
     */
    public RealValue(Log log, String id, String name, String description,
    ...
    public RealValue(Log log, String id, String name, String description,
        ...
        super(log, new ValueData(id, name, description, type.getId(), RealType.serialiseAll(type, values)), type);
    }
}
