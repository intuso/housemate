package com.intuso.housemate.object.proxy.simple.ioc;
...
public class SimpleProxyModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        install(new FactoryModuleBuilder().build(new TypeLiteral<HousemateObjectFactory<ServerData, SimpleProxyServer>>() {}));
