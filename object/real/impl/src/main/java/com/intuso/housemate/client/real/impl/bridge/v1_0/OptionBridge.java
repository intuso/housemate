...
public class OptionBridge
        extends BridgeObject<com.intuso.housemate.client.v1_0.api.object.Option.Data, Option.Data, Option.Listener<? super OptionBridge>>
        implements Option<ListBridge<SubTypeBridge>, OptionBridge> {

    private final ListBridge<SubTypeBridge> subTypes;
