...
public class ConditionDriverFactoryBridgeReverse implements ConditionDriver.Factory<ConditionDriver> {
    ...
    private final com.intuso.housemate.plugin.api.internal.driver.ConditionDriver.Factory<?> factory;
    private final ConditionDriverMapper conditionDriverMapper;

    @Inject
    public ConditionDriverFactoryBridgeReverse(@Assisted com.intuso.housemate.plugin.api.internal.driver.ConditionDriver.Factory<?> factory,
                                               ConditionDriverMapper conditionDriverMapper) {
        this.factory = factory;
        this.conditionDriverMapper = conditionDriverMapper;
    }

    public com.intuso.housemate.plugin.api.internal.driver.ConditionDriver.Factory<?> getFactory() {
        return factory;
    }
    ...
    private class CallbackBridge implements com.intuso.housemate.plugin.api.internal.driver.ConditionDriver.Callback {
    ...
    public interface Factory {
        ConditionDriverFactoryBridgeReverse create(com.intuso.housemate.plugin.api.internal.driver.ConditionDriver.Factory<?> conditionDriverFactory);
    }
}
