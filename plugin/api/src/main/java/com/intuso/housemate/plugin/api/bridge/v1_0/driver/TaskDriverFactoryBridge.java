...
public class TaskDriverFactoryBridge implements TaskDriver.Factory<TaskDriver> {
    ...
    private final com.intuso.housemate.plugin.v1_0.api.driver.TaskDriver.Factory<?> factory;
    private final TaskDriverMapper taskDriverMapper;

    @Inject
    public TaskDriverFactoryBridge(@Assisted com.intuso.housemate.plugin.v1_0.api.driver.TaskDriver.Factory<?> factory,
                                   TaskDriverMapper taskDriverMapper) {
        this.factory = factory;
        this.taskDriverMapper = taskDriverMapper;
    }

    public com.intuso.housemate.plugin.v1_0.api.driver.TaskDriver.Factory<?> getFactory() {
        return factory;
    }
    ...
    private class CallbackBridge implements com.intuso.housemate.plugin.v1_0.api.driver.TaskDriver.Callback {
    ...
    public interface Factory {
        TaskDriverFactoryBridge create(com.intuso.housemate.plugin.v1_0.api.driver.TaskDriver.Factory<?> taskDriverFactory);
    }
}
