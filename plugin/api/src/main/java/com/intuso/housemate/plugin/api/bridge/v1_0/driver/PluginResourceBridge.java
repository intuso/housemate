...
public class PluginResourceBridge<FROM, TO> implements PluginResource<TO> {
    ...
    private final com.intuso.housemate.plugin.v1_0.api.driver.PluginResource<FROM> pluginResource;
    private final Function<? super FROM, ? extends TO> convertFrom;

    public PluginResourceBridge(com.intuso.housemate.plugin.v1_0.api.driver.PluginResource<FROM> pluginResource, Function<? super FROM, ? extends TO> convertFrom) {
        this.pluginResource = pluginResource;
        this.convertFrom = convertFrom;
    }

    public com.intuso.housemate.plugin.v1_0.api.driver.PluginResource<FROM> getPluginResource() {
    ...
    private class ListenerBridge implements com.intuso.housemate.plugin.v1_0.api.driver.PluginResource.Listener<FROM> {
