...
public class TaskDriverFactoryBridgeReverse implements TaskDriver.Factory<TaskDriver> {
    ...
    private final com.intuso.housemate.plugin.api.internal.driver.TaskDriver.Factory<?> factory;
    private final TaskDriverMapper taskDriverMapper;

    @Inject
    public TaskDriverFactoryBridgeReverse(@Assisted com.intuso.housemate.plugin.api.internal.driver.TaskDriver.Factory<?> factory,
                                          TaskDriverMapper taskDriverMapper) {
        this.factory = factory;
        this.taskDriverMapper = taskDriverMapper;
    }

    public com.intuso.housemate.plugin.api.internal.driver.TaskDriver.Factory<?> getFactory() {
        return factory;
    }
    ...
    private class CallbackBridge implements com.intuso.housemate.plugin.api.internal.driver.TaskDriver.Callback {
    ...
    public interface Factory {
        TaskDriverFactoryBridgeReverse create(com.intuso.housemate.plugin.api.internal.driver.TaskDriver.Factory<?> taskDriverFactory);
    }
}
