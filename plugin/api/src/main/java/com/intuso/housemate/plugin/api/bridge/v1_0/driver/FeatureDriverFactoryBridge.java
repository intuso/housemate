...
public class FeatureDriverFactoryBridge implements FeatureDriver.Factory<FeatureDriver> {
    ...
    private final com.intuso.housemate.plugin.v1_0.api.driver.FeatureDriver.Factory<?> factory;
    private final FeatureDriverMapper featureDriverMapper;

    @Inject
    public FeatureDriverFactoryBridge(@Assisted com.intuso.housemate.plugin.v1_0.api.driver.FeatureDriver.Factory<?> factory,
                                      FeatureDriverMapper featureDriverMapper) {
        this.factory = factory;
        this.featureDriverMapper = featureDriverMapper;
    }

    public com.intuso.housemate.plugin.v1_0.api.driver.FeatureDriver.Factory<?> getFactory() {
        return factory;
    }
    ...
    private class CallbackBridge implements com.intuso.housemate.plugin.v1_0.api.driver.FeatureDriver.Callback {
    ...
    public interface Factory {
        FeatureDriverFactoryBridge create(com.intuso.housemate.plugin.v1_0.api.driver.FeatureDriver.Factory<?> featureDriverFactory);
    }
}
