...
public class RealObjectLoader {
    ...
    @Inject
    public RealObjectLoader(Log log, Persistence persistence, RealRoot root) {
        this.log = log;
    ...
    public void loadObjects() {
        loadHardwares(Lists.newArrayList("", ObjectRoot.HARDWARES_ID), root.getAddHardwareCommand());
        loadDevices(Lists.newArrayList("", ObjectRoot.DEVICES_ID), root.getAddDeviceCommand());
    }
