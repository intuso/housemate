...
public interface ProxyRoot<UL extends List<? extends User>,
            ...
            AL extends List<? extends Automation<?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?>>,
            C extends Command<?, ?>, R extends ProxyRoot<UL, TL, DL, AL, C, R>>
        extends Root<R, ProxyRootListener<? super R>>, HasUsers<UL>, HasTypes<TL>, HasDevices<DL>, HasAutomations<AL> {
