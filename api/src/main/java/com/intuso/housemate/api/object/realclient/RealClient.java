...
public interface RealClient<
            ...
            COMMAND extends RealClient<?, ?, ?, ?, ?, ?, ?, ?>,
            REALCLIENT extends RealClient<APPLICATIONS, AUTOMATIONS, DEVICES, HARDWARES, TYPES, USERS, COMMAND, REALCLIENT>>
        extends BaseHousemateObject<RealClientListener<? super REALCLIENT>>,
            HasTypes<TYPES>,
