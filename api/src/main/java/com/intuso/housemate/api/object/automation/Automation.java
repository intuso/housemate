...
public interface Automation<
            ...
            A extends Automation<RENAME_COMMAND, REMOVE_COMMAND, START_STOP_COMMAND, ADD_COMMMAND, RUNNING_VALUE, ERROR_VALUE, CONDITION, CONDITIONS, TASK, TASKS, A>>
        extends PrimaryObject<RENAME_COMMAND, REMOVE_COMMAND, START_STOP_COMMAND, RUNNING_VALUE, ERROR_VALUE, A, AutomationListener<? super A>>, HasConditions<CONDITIONS> {
