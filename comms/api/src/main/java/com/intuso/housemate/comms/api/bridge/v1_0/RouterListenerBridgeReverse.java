...
public class RouterListenerBridgeReverse implements Router.Listener<Router> {
    ...
    @Inject
    public RouterListenerBridgeReverse(ServerConnectionStatusMapper serverConnectionStatusMapper,
    ...
    public void serverConnectionStatusChanged(Router clientConnection, ServerConnectionStatus serverConnectionStatus) {
        listener.serverConnectionStatusChanged(router, serverConnectionStatusMapper.map(serverConnectionStatus));
    }
