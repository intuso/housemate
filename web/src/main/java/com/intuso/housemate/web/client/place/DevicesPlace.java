...
public class DevicesPlace extends HousematePlace {
    ...
    public List<HousemateObject.TreeLoadInfo> createTreeLoadInfos() {
        HousemateObject.TreeLoadInfo listInfo = new HousemateObject.TreeLoadInfo(ProxyRoot.DEVICES_ID);
        if(deviceIds != null)
        ...
        HousemateObject.TreeLoadInfo addInfo = new HousemateObject.TreeLoadInfo(ProxyRoot.ADD_DEVICE_ID, new HousemateObject.TreeLoadInfo(HousemateObject.EVERYTHING_RECURSIVE));
