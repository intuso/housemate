...
public class DevicesPlace extends HousematePlace {
    ...
    public List<HousemateObject.TreeLoadInfo> createTreeLoadInfos() {
        HousemateObject.TreeLoadInfo listInfo = new HousemateObject.TreeLoadInfo(ObjectRoot.DEVICES_ID);
        if(deviceIds != null)
        ...
        HousemateObject.TreeLoadInfo addInfo = new HousemateObject.TreeLoadInfo(ObjectRoot.ADD_DEVICE_ID, new HousemateObject.TreeLoadInfo(HousemateObject.EVERYTHING_RECURSIVE));
