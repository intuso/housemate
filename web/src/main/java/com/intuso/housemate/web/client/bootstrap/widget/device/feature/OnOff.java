...
public class OnOff
        ...
        implements com.intuso.housemate.api.object.device.feature.OnOff<GWTProxyCommand, GWTProxyValue> {

    public OnOff(GWTProxyDevice device) {
        super(device);
    }
    ...
    public Widget getWidget() {
        return new OnOffWidget();
    }

    public class OnOffWidget extends ToggleSwitch
