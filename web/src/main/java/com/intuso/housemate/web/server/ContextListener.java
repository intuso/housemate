    ...
    public void contextInitialized(ServletContextEvent servletContextEvent) {
        ...
        if(INJECTOR == null) {
            ...
            if(injector != null && injector instanceof Injector)
                ...
                INJECTOR = Guice.createInjector(new PCClientModule(defaultProperties, properties, "web-server.log"),
                        new JavabinSerialiserClientModule(), new SocketClientModule(defaultProperties));
            }
        }
