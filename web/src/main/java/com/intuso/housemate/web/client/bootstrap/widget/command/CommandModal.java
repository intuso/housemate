 ...
 */
public class CommandModal extends Composite implements com.intuso.housemate.client.v1_0.api.object.Command.PerformListener<GWTProxyCommand> {
    ...
    private final com.intuso.housemate.client.v1_0.api.object.Command.PerformListener<GWTProxyCommand> listener;

    public CommandModal(GWTProxyList<Type.Data<?>, GWTProxyType> types, GWTProxyCommand command) {
        this(types, command, null);
    }

    public CommandModal(GWTProxyList<Type.Data<?>, GWTProxyType> types, GWTProxyCommand command, com.intuso.housemate.client.v1_0.api.object.Command.PerformListener<GWTProxyCommand> listener) {
