...
public class DayOfTheWeek extends BrokerRealCondition {
	 ...
	 */
    @Inject
	public DayOfTheWeek(BrokerRealResources brokerRealResources, String id, String name, String description,
                        BrokerRealConditionOwner owner, DaysType daysType) throws HousemateException {
		super(brokerRealResources, id, name, description, owner);
        days = new BrokerRealProperty<Day>(brokerRealResources, DAYS_FIELD, DAYS_FIELD, "The days that satisfy the condition",
