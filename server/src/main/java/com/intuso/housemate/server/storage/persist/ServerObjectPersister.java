...
public class ServerObjectPersister {
    ...
    @Inject
    public ServerObjectPersister(ApplicationListWatcher applicationListWatcher, AutomationListWatcher automationListWatcher, UserListWatcher userListWatcher) {
