...
import com.intuso.housemate.api.object.server.ServerListener;
...
public class ServerBridge
        ...
        ServerBridge, ServerListener<? super ServerBridge>>
        implements Server<
            ...
            public void perform(TypeInstanceMap values) throws HousemateException {
                if(values != null && values.getChildren().containsKey(NAME_ID)) {
                    ...
                    if (newName != null && !ServerBridge.this.getData().getName().equals(newName)) {
                        ...
                        ServerBridge.this.broadcastMessage(NEW_NAME, new StringPayload(newName));
                        try {
